classdef opticalSerial < handle    
    ...
    properties (SetAccess = private)
        ...
        portName = '/dev/tty.USA19H141P1.1' ; %Kabir edit, new Port for new keyspan device.%'/dev/tty.USA19H62P1.1';
    ...
    methods
        ...
        function getLuminance(self, numSamples, pauseBetweenSamples)
            ...
            self.values = nan(numSamples, 1); %Kabir edit %nans(numSamples, 1);
            out         = zeros(4,1,'uint8');
