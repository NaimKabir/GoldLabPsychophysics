...
global FOLDERNAME
	...
	figh = figure('menuBar','none','name','Calibration Result - Press [y]/n to continue','Color', Calib.bkcolor/255,'Renderer', 'Painters','keypressfcn','close;');
