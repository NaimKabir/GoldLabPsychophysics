...
%I'm going to a use a moving average window of 5 values. 
%If that doesn't make any sense, it will in a second.
...
averagedvector(3) = mean([1 3 2 4 5]);

%... and so on and so forth until I get to the end.

%ASSIGNMENT:
%Do a moving average for eyedata, using a window of 15. You won't be able
%to do it manually, so think in loops...
